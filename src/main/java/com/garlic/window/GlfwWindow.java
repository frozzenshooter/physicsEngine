...
public class GlfwWindow implements Window {
    ...
    public GlfwWindow(WindowProperties properties, EventCallback callback) {
        this.width = properties.getWidth();
        this.height = properties.getHeight();
        this.title = properties.getTitle();
        this.vSyncEnabled = properties.isVSyncEnabled();
    ...
    public void pollEvents() {
        // Poll for window events. The callbacks will only be invoked during this call.
        glfwPollEvents();
    }
